...
| UX Designer | Documentation quality, user experience | Technical writing, content creation |
...
2. **Documentation Quality**
   ...
   - Written tutorials professional
   - API docs complete
...
- [ ] Written guides completed (if applicable)
